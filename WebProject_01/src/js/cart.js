...
function totalCost(event){
    ...
    total_field.children[0].innerText = 'SR' +  quantity.value * price_field_content
    grandTotal()
...
function grandTotal(){
    ...
    for(let i = 0; i < all_total_fields.length; i++){
        all_prices = Number(all_total_fields[i].innerText.replace('SR', ''))
        total+=all_prices
    }
    grand_total.children[0].innerText = "SR"+total
